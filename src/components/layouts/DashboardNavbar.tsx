...
import AppLogo from '@/public/IDS.png';
...
// };
const navigation = [
  { name: `หน้าแรก`, href: `/dashboard`, current: true },
  { name: `ผู้ใช้งาน`, href: `/dashboard/user`, current: false },
  { name: `สินค้า`, href: `/dashboard/prodcut`, current: false },
